...
extern "C" constexpr STRUCT_LAYOUT_THEME LAYOUT_THEMES[LAYOUT_THEMES_COUNT] =
	{
		// Default
		{
			...
			.BOTTOM_BUTTONS_ARROWS_WIDTH = (uint16_t)((FUNCBUTTONS_ON_PAGE == 8) ? 32 : 31),
		...
		// Classic
		{
			...
			.FFT_PRINT_SIZE = LAYOUT_THEMES[0].FFT_PRINT_SIZE,
			.FFT_CWDECODER_OFFSET = LAYOUT_THEMES[0].FFT_CWDECODER_OFFSET,
			.FFT_FFTWTF_POS_Y = (uint16_t)(LCD_HEIGHT - LAYOUT_THEMES[3].FFT_HEIGHT_STYLE1 - LAYOUT_THEMES[3].WTF_HEIGHT_STYLE1 - LAYOUT_THEMES[3].BOTTOM_BUTTONS_BLOCK_HEIGHT - LAYOUT_THEMES[3].TOPBUTTONS_HEIGHT),
		...
		// Hristo
		{
			...
			.STATUS_LABEL_RIT_Y_OFFSET = 5,
			.STATUS_IFGAIN_OFFSET_X = 495,
			.STATUS_IFGAIN_OFFSET_Y = 5,
			.STATUS_IFGAIN_WIDTH = 40,
			.STATUS_IFGAIN_HEIGTH = 6,
			.STATUS_AFGAIN_OFFSET_X = 495,
			.STATUS_AFGAIN_OFFSET_Y = 20,
			.STATUS_AFGAIN_WIDTH = 40,
			.STATUS_AFGAIN_HEIGTH = 6,
